...
<Snippet text={["npm install -g zizou-ai", "zizou"]} width="100%" />
...
<Snippet text={["git clone https://github.com/arnvg17/zizou.git", "cd zizou", "bun install", "bun run src/cli.tsx"]} width="100%" />
